...
func initializeClient(user *ds.User, gs *ds.GameState) {
	...
	envelope := ds.WsEnvelope{Type: "game.initialLoad", Msg: ds.SendAbleGamestate{Users: gs.Users, Schedules: gs.Schedules, Stations: stationMap, Tiles: gs.Tiles, Trains: gs.Trains, ActiveTiles: gs.ActiveTiles, ConfigData: gs.ConfigData, Money: gs.Money}}
